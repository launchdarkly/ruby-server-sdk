  ...
  describe Config do
    ...
    describe "context and user aliases" do
      it "default values are aliased correctly" do
        expect(Config.default_context_keys_capacity).to eq Config.default_user_keys_capacity
        expect(Config.default_context_keys_flush_interval).to eq Config.default_user_keys_flush_interval
      end
