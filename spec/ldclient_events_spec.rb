    ...
    context "evaluation events - variation" do
      it "unknown flag" do
        with_client(test_config) do |client|
          ...
          expect(event_processor(client)).to receive(:record_eval_event).with(
            context, 'badkey', nil, nil, 'default', nil, 'default', false, nil, nil, 1, false, false
           )
      ...
      it "known flag" do
        ...
        with_client(test_config(data_source: td)) do |client|
          expect(event_processor(client)).to receive(:record_eval_event).with(
            context, 'flagkey', 1, 0, 'value', nil, 'default', false, nil, nil, nil, false, false
          )
      ...
      it "sets trackEvents and reason if trackEvents is set for matched rule" do
        ...
        with_client(test_config(data_source: td)) do |client|
          expect(event_processor(client)).to receive(:record_eval_event).with(
            ...
            'default', true, nil, nil, nil, false, false
          )
          client.variation("flagkey", context, "default")
        end
      end
      ...
      it "unknown flag" do
        with_client(test_config) do |client|
          ...
          expect(event_processor(client)).to receive(:record_eval_event).with(
            ...
            'default', false, nil, nil, 1, false, false
          )
      ...
      it "known flag" do
        ...
        with_client(test_config(data_source: td)) do |client|
          expect(event_processor(client)).to receive(:record_eval_event).with(
            ...
            'default', false, nil, nil, nil, false, false
          )
